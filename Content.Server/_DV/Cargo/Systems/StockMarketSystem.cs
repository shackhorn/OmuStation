...
public sealed class StockMarketSystem : EntitySystem
{
        ...
        int amount)
    {
        ...
        var accountBalance = bank.Accounts.GetValueOrDefault("Cargo");      // Omu fix since we use seperate bank accounts for each dept
        ...
        _cargo.UpdateBankAccount(station, -totalValue, "Cargo");
