...
# Omu - Tailwag
marking-FelinidFluffyTail = Fluffy Tail (Animated)
# Omu - Tailwag
marking-FelinidFluffyTailRings = Fluffy Tail with rings (Animated)
# Omu - Tailwag
marking-FelinidAlternativeTail = Alternative Tail (Animated)
